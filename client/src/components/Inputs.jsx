        ...
        <div className="w-full p-2 bg-[#141a27] text-white shadow-sm shadow-white flex items-center justify-between sticky left-0  z-10">
          <div className="flex items-center gap-3">
            <NavLink
              ...
              className={({ isActive }) =>
                `  ${
                  isActive ? "border-b-2 animate-pulse" : "border-0"
                }  pb-0.5 border-b-orange-500 cursor-pointer `
              }
            >
              All projects
            </NavLink>
          ...
          <div className="drawer max-w-fit">
            ...
            <div className="drawer-content inline-block">
              <label
                htmlFor="my-drawer-1"
                className="tooltip tooltip-bottom md:hidden cursor-pointer"
                data-tip="user"
              >
                <FaUser className="border rounded-full p-1  text-2xl" />
              </label>
            </div>
